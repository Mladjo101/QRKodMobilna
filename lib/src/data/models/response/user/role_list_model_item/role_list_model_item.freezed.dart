...
abstract class $RoleListModelItemCopyWith<$Res> {
  factory $RoleListModelItemCopyWith(
      ...
      _$RoleListModelItemCopyWithImpl<$Res>;
  $Res call({int id, String naziv, int? vrijednostUAplikaciji});
}

/// @nodoc
class _$RoleListModelItemCopyWithImpl<$Res>
    implements $RoleListModelItemCopyWith<$Res> {
  _$RoleListModelItemCopyWithImpl(this._value, this._then);

  final RoleListModelItem _value;
  // ignore: unused_field
  final $Res Function(RoleListModelItem) _then;
    ...
    return _then(_value.copyWith(
      ...
      naziv: naziv == freezed
          ...
          : naziv // ignore: cast_nullable_to_non_nullable
              as String,
      vrijednostUAplikaciji: vrijednostUAplikaciji == freezed
...
class __$$_RoleListModelItemCopyWithImpl<$Res>
    extends _$RoleListModelItemCopyWithImpl<$Res>
  ...
  __$$_RoleListModelItemCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_RoleListModelItem));

  @override
  _$_RoleListModelItem get _value => super._value as _$_RoleListModelItem;
...
class _$_RoleListModelItem implements _RoleListModelItem {
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.vrijednostUAplikaciji, vrijednostUAplikaciji));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(vrijednostUAplikaciji));
